...
import sys
import random
from device_enums import DeviceEnums
reload(sys)
...
class UserAgentUtil(object):
    ...
    def random_one(self, device):
        return random.choice(self.useragents[device.name])


def Main():
    ua = UserAgentUtil()
    print(ua.random_one(DeviceEnums.baidu_mobile))
